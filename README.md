<p align="center">
  <img src="assets/doltap.jpg" width="300" alt="어두운 배경 위에 자연석 다섯 개를 쌓은 돌탑">
</p>

# doltap

**세션이 바뀌어도, 이어갈 자리는 남도록.**

AI와 정한 규칙, 지금 하는 일, 그렇게 결정한 이유를 프로젝트 안에 남깁니다.
doltap은 다음 세션이 어디서 다시 시작할지 찾을 수 있도록 문서의 자리와 연결을 정리합니다.
...
- 새 세션을 열 때마다 지난 작업과 다음 할 일을 다시 설명하고 있을 때
- 도구마다 규칙을 따로 적어 두어 어느 쪽이 최신인지 헷갈릴 때
- 코드와 문서는 남았는데 왜 그렇게 결정했는지 찾기 어려울 때
...
처음이라면 [앵커·ID·관계의 개념](guide/concepts.md)을 읽고,
[대작업 생성 → 진행 → 아카이브](guide/workstreams.md)로 이어가세요.
