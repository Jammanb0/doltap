...
export function fullCheck(root) {
  ...
  if (existsSync(join(root, '.doltap/project.md')) && !existsSync(join(root, '.doltap/plans/project.md'))) old.problems.unshift({ where: '.doltap/project.md', message: '프로젝트 설명은 plans/project.md로 옮깁니다. doltap migrate를 미리보기부터 실행하세요' });
