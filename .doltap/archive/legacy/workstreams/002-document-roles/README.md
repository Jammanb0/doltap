<a name="doltap-d-zkdqf9se-start" id="doltap-d-zkdqf9se-start"></a>
...
- `indexes` [decisions.md](decisions.md#doltap-d-96221xf0-start)

- `indexes` [plan.md](plan.md#doltap-d-9p8xas2z-start)

- `indexes` [status.md](status.md#doltap-d-sjtacfx3-start)

<a name="doltap-d-zkdqf9se-end" id="doltap-d-zkdqf9se-end"></a>
